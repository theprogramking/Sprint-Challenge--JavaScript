...
const unisWithUni = graduates.filter((i) => {
  if(i.university.includes("Uni")) return 1;
});
...
*/
const zooAnimalsPopulations = zooAnimals.map((i) => {
  return i.population;
});
const populationTotal = zooAnimalsPopulations.reduce((a, b) => {
  return a + b;
});
